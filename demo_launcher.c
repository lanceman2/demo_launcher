...
usage(char *argv0)
{
    fprintf(stderr,
        ...
        " a program for each line.\n"
        "\n"
        "   This launcher does not manage the programs that it\n"
        " launches, so quiting this launcher will not terminate\n"
        " all the launched programs.  If you terminate this\n"
        " launcher by signaling it from a shell, the shell may\n"
